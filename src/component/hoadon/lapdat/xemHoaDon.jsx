                ...
                <div className={Styles.container} ref={pdfRef}>
                    ...
                    <div className={Styles.information}>
                        ...
                        <div className={Styles.linhkienthay}>
                            <p style={{ fontWeight: '500', marginBottom: '12px' }}>Linh kiện lắp</p>
                            <table>
                                <thead>
                        ...
                        <div className={Styles.inforSC}>
                            <div className={Styles.inforLeft}>
                                ...
                                <div className={Styles.bottomtitle}>
                                    <p>Thiết bị lắp: {hoadon.ThietBiLap}</p>
                                    <p>Tiến độ: {hoadon.TienDoHD == 0 ? "Đợi lắp" : hoadon.TienDoHD == 1 ? "Đang tiến hành" : "Đã xong"}</p>
